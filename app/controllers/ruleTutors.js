app.controller("rulesTutorsCtrl",["$scope", "$http", function($scope,$http) {
	// body...
	...
	$scope.main = function(){
		$http.get('/rulestutor').then(successCallback,errorCallback);
	...
	$scope.mainroute = function(){
		$http.get('/rulestutor/test').then(successCallback,errorCallback);
