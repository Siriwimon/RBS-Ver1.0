app.controller("rulesLinuxCtrl",["$scope", "$http", function($scope,$http) {
	// body...
	...
	$scope.main = function(){
		$http.get('/ruleslinux').then(successCallback,errorCallback);
	...
	$scope.mainroute = function(){
		$http.get('/ruleslinux/test').then(successCallback,errorCallback);
